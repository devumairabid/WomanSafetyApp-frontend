...
const OnlineSafety = () => {
    ...
    return (
        <View style={{ backgroundColor: '#FFECD0', flex: 1 }} >
            <View style={{ flex: 0.1, display: 'flex', flexDirection: 'row', marginTop: 30, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', alignContent: 'center', gap: 8 }}>
                <TouchableOpacity onPress={() => navigation.navigate('TabNavigation')}>

                    <Image source={require('../../assets/images/leftArrow.png')} style={{ width: 30, height: 30, }} />
                </TouchableOpacity>
                <Text style={{ fontSize: 26, fontFamily: 'Nunito-SemiBold', color: '#372329', }}>Woman Online Safety</Text>
