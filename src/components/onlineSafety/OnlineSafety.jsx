        ...
        <View style={{ backgroundColor: '#FFECD0', flex: 1 }} >
            <View style={{ flex: 0.1, display: 'flex', flexDirection: 'row', marginTop: pixelSizeVertical(30), alignSelf: 'center', alignItems: 'center', justifyContent: 'center', alignContent: 'center', gap: pixelSizeHorizontal(10) }}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('TabNavigation')}>
                    ...
                    <Image source={require('../../assets/images/leftArrow.png')} style={{ width: widthPixel(30), height: heightPixel(30), left: pixelSizeHorizontal(5) }} />
                </TouchableOpacity>
                <Text style={{ fontSize: fontPixel(30), fontFamily: 'Nunito-SemiBold', color: '#372329', }}>Woman Online Safety</Text>
